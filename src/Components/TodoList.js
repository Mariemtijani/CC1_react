...
import {faSquareCheck,faRotateLeft,faAdd} from  '@fortawesome/free-solid-svg-icons';
...
const changeTask = (e) => {
  ...
  return (
    ...
    <div className='todoForm border border-2'>
     ...
     <h3> {currentDay}</h3>  
      ...
      {updateTodo ? (
        ...
        <div className="col " >
        <input type="text"
          className='updateInput form-control w-100 border border-0 border-bottom '
